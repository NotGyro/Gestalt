...
pub mod hemlock_scopes {
    ...
    lazy_static! {
        pub static ref Core:     u32 = hemlock::register_scope(Scope::new("Core").log(Verbose).print(Verbose));
        ...
        pub static ref Library:  u32 = hemlock::register_scope(Scope::new("Library").log(Verbose).print(Verbose));
