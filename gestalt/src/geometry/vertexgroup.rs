...
pub struct VertexGroup {
    ...
    pub vertex_buffer: Option<Arc<CpuAccessibleBufferAutoPool<[PBRPipelineVertex]>>>,
...
impl VertexGroup {
    ...
    pub fn new(verts: Vec<PBRPipelineVertex>, idxs: Vec<u32>, mat_id: u8, device: Arc<Device>, memory_pool: AutoMemoryPool) -> VertexGroup {
