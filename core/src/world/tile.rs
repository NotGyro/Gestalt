...
pub trait ValidTile:
    'static + Sized + Copy + Clone + PartialEq + PartialOrd + Hash + fmt::Debug + Default
{
}
impl<T> ValidTile for T where
    T: 'static + Sized + Copy + Clone + PartialEq + PartialOrd + Hash + fmt::Debug + Default
{
}
